...
function App() {
  ...
  return (
    <main className="app">
      <header className="hero"><div><p className="eyebrow">PCB Inventory</p><h1>PCB 재고관리</h1><p>부품, 입출고, BOM, 위치/랙, CSV를 한 화면에서 관리합니다.</p></div><div className="stats"><span><b>{parts.length}</b> 품목</span><span><b>{totalQuantity}</b> 총수량</span><span className={lowStockCount ? 'danger' : ''}><b>{lowStockCount}</b> 부족</span></div></header>
